...
const Blogs = () => {
    const baseUrl = "https://www.api.creativencolourful.com/api/v1/blog";
                                ...
                                <div className="p-5">
                                    ...
                                    <div className="flex justify-between items-center">
                                        <button
                                            ...
                                            className="text-[#81190B] hover:text-blue-800 flex items-center gap-1"
                                        >
          ...
          <small className="text-gray-600 flex items-center space-x-2">
            *Upload Image at
            <a
              ...
              className="text-blue-500 hover:text-[#81190B] flex items-center"
            >
              <img
