...
function Reports() {
  ...
  const fetchReportData = async () => {
    try {
      setLoading(true);
      setError('');
      const response = await axios.post('https://www.api.creativencolourful.com/api/v1/get-reports', {
        reportType,
  ...
  return (
    <div className={`min-h-screen transition-colors duration-200  'dark bg-[#81190B]' : 'bg-gray-50'}`}>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                <div className="flex items-center space-x-4">
                  <div className="p-3 bg-blue-100 dark:bg-blue-900 rounded-lg">
                    <TrendingUp className="w-6 h-6 text-[#81190B] dark:text-blue-400" />
                  </div>
                  <div>
