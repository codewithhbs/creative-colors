...
const Hero = () => {
        ...
        const fetchHeroPageData = async () => {
            try {
                ...
                const response = await axios.get(
                    "https://www.api.creativencolourful.com/api/v1/admin/get/hero_page"
                );
    ...
    const updateHeroPageData = async () => {
        try {
            setLoading(true);
            await axios.post("https://www.api.creativencolourful.com/api/v1/admin/create_and_update/hero_page", heroPageData);
                            ...
                            <>
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <Link
                                        ...
                                        className="group flex items-center gap-2 bg-[#81190B] hover:bg-gray-800 text-white px-8 py-4 rounded-full text-lg font-semibold transition-all duration-300"
                                    >
