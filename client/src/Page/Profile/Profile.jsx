...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    const fetchUser = async () => {
      ...
      try {
        const { data } = await axios.get(
          "https://www.api.creativencolourful.com/api/v1/my-details",
          {
            headers: {
    ...
    const fetchOrder = async () => {
      ...
      try {
        const { data } = await axios.get(
          "https://www.api.creativencolourful.com/api/v1/my-all-order",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  const handleDeleteAccount = async () => {
    try {
      ...
      const { data } = await axios.delete(
        "https://www.api.creativencolourful.com/api/v1/delete-account",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleRefundRequest = async () => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://www.api.creativencolourful.com/api/v1/refund-request-order/${selectedOrder._id}`,
        {
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <button
                      ...
                      className="flex items-center px-4 py-2 bg-black text-white rounded-lg hover:bg-[#1e1f24] transition-colors"
                    >
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900">
                            {user.isMobileVerifed ? "Verified" : "Pending"}
                          </p>
                        </div>
                      </div>
            ...
            {activeTab === "orders" && (
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                {orders.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {orders &&
                      (Array.isArray(orders) ? orders : [orders]).map(
                        (order) => (
                          <div
                            key={order._id}
                          ...
                          >
                                    ...
                                    <a
                                      href={
                                        order?.paymentType == "COD"
                                          ? `/receipt-cod/order-confirmed?id=${order?._id}`
                                          : `/Receipt/order-confirmed?data=${order?.orderId}`
                                      }
                            ...
                            {order.refundRequest && (
                              <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-4">
                                ...
                                <p className="text-xs text-orange-600 mt-1">
                                  Your refund request is being processed. We'll
                                  update you soon.
                                </p>
                              </div>
                            )}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                                  ...
                                  <div>
                                    ...
                                    <span className="text-green-800">
                                      ₹{order.offerId.minimumOrderAmount}
                                    </span>
                                  </div>
                                  <div>
                                    <span className="text-green-700 font-medium">
                                    ...
                                    <span className="text-green-800 font-semibold">
                                      ₹
                                      {(
                                        order.totalAmount - order.payAmt
                                      ).toFixed(2)}
                                    </span>
                                  </div>
                                </div>
                            ...
                            {order.shiprocket?.awb_code && (
                              <button
                                ...
                                className="flex items-center px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-900 transition-colors text-sm"
                              >
                              ...
                              <div className="mt-4 pt-4 border-t border-gray-200">
                                ...
                                <div className="space-y-1 text-sm">
                                  ...
                                  <div className="flex justify-between text-green-600">
                                    <span>
                                      Discount ({order.offerId.discount}%):
                                    </span>
                                    <span>
                                      -₹
                                      {(
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-black text-white rounded-lg hover:bg-[#1e1f24] transition-colors"
                      >
                        Change
                      </button>
                    </div>
