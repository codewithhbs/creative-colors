...
const VerifyOtp = ({ onVerificationSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('https://www.api.creativencolourful.com/api/v1/verify-otp', {
                method: 'POST',
                headers: {
    ...
    const handleResendOtp = async () => {
        ...
        try {
            // Using the same API endpoint as the Otp component
            const response = await fetch('https://www.api.creativencolourful.com/api/v1/resend-otp', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            >
                ...
                <div className="relative z-10 bg-white/95 backdrop-blur-sm rounded-3xl p-8 max-w-md w-full text-center shadow-2xl">
                    ...
                    <button
                        ...
                        className="inline-block w-full bg-gradient-to-r from-[#FFB229] to-pink-500 text-white py-3 rounded-xl font-semibold hover:from-orange-600 hover:to-pink-600 transition-all transform hover:scale-105"
                    >
  ...
  <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden">
    ...
    {/* Header */}
    <div className="bg-gradient-to-r from-[#FFB229] to-pink-500 p-8 text-center">
    ...
    <div className="p-8">
      ...
      <button 
        ...
        className="inline-flex items-center text-[#FFB229] hover:text-pink-500 mb-6 transition-colors"
      >
      ...
      <div className="space-y-6">
            ...
            {otp.map((digit, index) => (
              <input
                ...
                className="w-12 h-12 text-center text-xl font-bold border-2 border-gray-300 
                           rounded-xl focus:ring-2 focus:ring-[#FFB229] focus:border-[#FFB229] 
        ...
        <div className="text-center space-y-3">
          <div className="flex items-center justify-center text-gray-600">
            <Clock className="w-4 h-4 mr-2 text-[#FFB229]" />
          ...
          {canResend ? (
            <button
              ...
              className="inline-flex items-center text-[#FFB229] hover:text-pink-500 font-semibold transition-colors disabled:opacity-50"
            >
        ...
        <button
          ...
          className="w-full bg-[#862113] text-white py-4 rounded-xl font-semibold text-lg 
                     hover:from-orange-600 hover:to-pink-600 transition-all transform hover:scale-105 
                     disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg flex items-center justify-center"
        >
          {isVerifying ? (
            <>
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-gray-600">
          Having trouble? <span className="text-[#FFB229] hover:text-pink-500 font-semibold cursor-pointer">Contact Support</span>
        </p>
      </div>
    </div>
  </div>
