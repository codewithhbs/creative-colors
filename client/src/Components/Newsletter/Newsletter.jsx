...
const Newsletter = () => {
  ...
  const handleSubmit = async(e) => {
    e.preventDefault()
    try {
      const response = await axios.post('https://www.api.creativencolourful.com/api/v1/create-newsletter', { email })
          ...
          <div className="text-center">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full py-3 cursor-pointer bg-[#FFB229] hover:bg-[#D19A40] text-white font-semibold rounded-lg transition-colors"
              >
                Subscribe
              </button>
            </div>
